...
**The 1.21.8 branch has been discontinued due to CubeKrowd no longer supporting that version.**
...
- BuildTeam chat messages not being themed.
- Empty chat messages not being themed.
